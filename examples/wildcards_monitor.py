...
client.subscribe(Topic(payload_type=Metric, node_id="+", context=("#",)))  # example/v1/_Metric/+/#

# publish a couple for demo
client.publish(Topic(payload_type=Metric, node_id="metric-tap", context=("line-1","motor-7","speed")), Metric(123.4))
client.publish(Topic(payload_type=Metric, node_id="metric-tap", context=("line-2","oven","temp")), Metric(456.7))
